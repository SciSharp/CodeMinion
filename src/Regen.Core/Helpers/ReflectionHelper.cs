...
namespace Regen.Helpers {
    public static class ReflectionHelper {
        ...
        ///     Checks if the type/object has this interface.
        /// </summary>
        public static bool HasInterface<T>(this Type type) { return typeof(T).IsAssignableFrom(type); }
        ...
        public static bool IsValueTupleType(this Type type) { return (type.GetTypeInfo().IsGenericType && ValueTupleTypes.Contains(type.GetGenericTypeDefinition())) || type.Name.StartsWith("Tuple`"); }
