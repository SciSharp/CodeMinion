...
namespace Regen.Compiler.Expressions {
    public class NumberLiteral : Expression, IEquatable<NumberLiteral>, IEquatable<string> {
        ...
        public static NumberLiteral Parse(ExpressionWalker ew) {
            ...
            var ret = new NumberLiteral(ew.Current.Match.Value) {_match = ew.Current.Match};
            ew.Next();
            return ret;
        }
        ...
        /// <summary>Returns a value that indicates whether the values of two <see cref="T:Regen.Compiler.Expressions.NumberLiteral" /> objects are equal.</summary>
        ...
        /// <summary>Returns a value that indicates whether two <see cref="T:Regen.Compiler.Expressions.NumberLiteral" /> objects have different values.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
