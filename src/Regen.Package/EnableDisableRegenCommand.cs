...
namespace Regen {
    ...
    /// Command handler
    /// </summary>
    internal sealed class EnableDisableRegenCommand {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private EnableDisableRegenCommand(AsyncPackage package, OleMenuCommandService commandService) {
        ...
        /// </summary>
        public static EnableDisableRegenCommand Instance { get; private set; }
