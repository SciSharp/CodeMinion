...
namespace Regen {
    ...
    /// Command handler
    /// </summary>
    internal sealed class CompileFileCommand {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CompileFileCommand(AsyncPackage package, OleMenuCommandService commandService) {
        ...
        /// </summary>
        public static CompileFileCommand Instance { get; private set; }
