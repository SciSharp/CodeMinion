...
namespace Regen {
    ...
    [Guid(RegenPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class RegenPackage : AsyncPackage {
        /// <summary>
        /// RegenPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "daa62660-6c0a-4371-bee5-37015553ae21";

        /// <summary>
        /// Initializes a new instance of the <see cref="RegenPackage"/> class.
        /// </summary>
        public RegenPackage() {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress) {
            ...
            foreach (var f in files.Where(f => !f.ToLower().EndsWith("regen.package.dll")))
            {
                try
                {
            ...
            await CompileSelectionCommand.InitializeAsync(this);
